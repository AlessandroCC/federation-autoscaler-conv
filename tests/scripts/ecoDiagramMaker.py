...
experiment size, e.g.:
    ...
    python3 tests/scripts/ecoDiagramMaker.py --input results/3c-7p/reservations.csv
    python3 tests/scripts/ecoDiagramMaker.py --input results/8c-17p/reservations.csv
    python3 tests/scripts/ecoDiagramMaker.py --input results/15c-35p/reservations.csv
    python3 tests/scripts/ecoDiagramMaker.py --input results/30c-70p/reservations.csv
    ...
    *,
    ...
    lines = [
        ...
        *warnings_lines,
        "\n## Reproduce\n\n",
        "```bash\n",
        f"python3 tests/scripts/ecoDiagramMaker.py --input {input_path}\n",
        "```\n",
    ]
